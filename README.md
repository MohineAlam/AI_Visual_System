...
```bash
  python test/test_default_pytorch_model.py -o /path/to/output/folder
```
...
```bash
  python train/train_your_model.py -t /path/to/training/dataset -v /path/to/validate/dataset -c 5
```
